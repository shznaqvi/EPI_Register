...
import edu.aku.hassannaqvi.epi_register.core.AppInfo;
 ...
 /*            countryCode = getCountryCode(this);
    ...
    public void onSyncDataClick(View view) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            startActivity(new Intent(this, edu.aku.hassannaqvi.epi_register.ui.SyncActivity.class).putExtra("login", true));
        } else {
    ...
    public void attemptLogin(View view) {
        ...
        if (attemptCounter == 7) {
            Intent iLogin = new Intent(edu.aku.hassannaqvi.epi_register.ui.LoginActivity.this, MainActivity.class);
